...
def forward_to_chat(update, context):
    """{ 
        'message_id': 5, 
        'date': 1605106546, 
        'chat': {'id': 49820636, 'type': 'private', 'username': 'aryzhkin', 'first_name': 'Andrey', 'last_name': 'Ryzhkin'}, 
        'text': 'Test text', 'entities': [], 'caption_entities': [], 'photo': [], 'new_chat_members': [], 'new_chat_photo': [], 'delete_chat_photo': False, 'group_chat_created': False, 'supergroup_chat_created': False, 'channel_chat_created': False, 
        'from': {'id': 49820636, 'first_name': 'Andrey', 'is_bot': False, 'last_name': 'Ryzhkin', 'username': 'aryzhkin', 'language_code': 'en'}
    }"""
...
def forward_to_user(update, context):
    """{
        ...
        'reply_to_message': {
            ...
            'chat': {'id': -484179205, 'type': 'group', 'title': '☎️ SUPPORT CHAT', 'all_members_are_administrators': True}, 
            'forward_from': {'id': 49820636, 'first_name': 'Andrey', 'is_bot': False, 'last_name': 'Ryzhkin', 'aryzhkin': 'Ryzhkin', 'language_code': 'en'}, 
